...
@Composable
fun LoginScreen(innerPadding: PaddingValues, viewModel: LoginViewModel, state: LoginState) {
        ...
        ClickableText(
            ...
            onClick = { offset ->
                annotatedString.getStringAnnotations(
                    ...
                    //todo: abrir vista para registro de nuevo usuario
                    Log.i("Login", "abrir registro de nuevo usuario")
                }
            },
